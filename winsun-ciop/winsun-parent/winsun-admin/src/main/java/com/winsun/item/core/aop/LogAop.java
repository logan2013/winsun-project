package com.winsun.item.core.aop;

import com.winsun.item.core.common.annotion.BussinessLog;
import com.winsun.item.core.common.constant.dictmap.base.AbstractDictMap;
...
import com.winsun.item.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.winsun.item.core.common.annotion.BussinessLog)")
