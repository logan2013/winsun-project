...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager securityManager(CookieRememberMeManager rememberMeManager, CacheManager cacheShiroManager, SessionManager sessionManager) {
        ...
        MyWebSessionManager webSessionManager = new MyWebSessionManager();//使用自定义的sessionManager
        webSessionManager.setSessionValidationInterval(30 * 60 * 1000);
        webSessionManager.setGlobalSessionTimeout(6 * 60 * 60 * 1000);
