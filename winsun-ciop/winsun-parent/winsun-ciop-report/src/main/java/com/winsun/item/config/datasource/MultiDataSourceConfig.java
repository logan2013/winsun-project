package com.winsun.item.config.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.baomidou.mybatisplus.plugins.OptimisticLockerInterceptor;
import com.baomidou.mybatisplus.plugins.PaginationInterceptor;
import com.winsun.item.core.config.properties.DruidProperties;
import com.winsun.item.core.config.properties.MutiDataSourceProperties;
import com.winsun.item.core.datascope.DataScopeInterceptor;
import com.winsun.item.core.mutidatasource.DynamicDataSource;
...
@MapperScan(basePackages = {"com.winsun.item.modular.*.dao","com.winsun.item.multi.mapper"})
