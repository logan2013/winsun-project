...
DROP DATABASE IF EXISTS winsun_admin;
CREATE DATABASE IF NOT EXISTS winsun_admin DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('6', '世界', '10', '欢迎使用winsun管理系统', '2017-01-11 08:53:20', '1');
