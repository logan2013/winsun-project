...
public interface IMenuService extends IService<Menu> {
     ...
     */
    List<MenuNode> getMenusByRoleIds(@Param("roleIds")List<Integer> roleIds, @Param("pcode")String pcode);
    
    /**
     * 修改菜单权限状态
     */
    void setStatus(@Param("menuId") Long menuId, @Param("status") int status);
}
